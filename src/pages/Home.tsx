    ...
    <>
      ...
      <section className="container--dark">
        ...
        <div className="container__content">
          ...
          >
            <p className="fw-bold">
              ...
              statutem pro pěstování a vinifikaci, tak aby mohla vznikat
              komplexní vína, která obstojí v čase.
            </p>
          </FadeUp>
        </div>
        ...
        <div className="container__content light ">
          ...
          >
            <p>
              Terroirní vína potřebují čas, čas na zrání na sudu a čas na zrání
              na láhvi. Proto i při jeho vychutnávání nelze spěchat. Dejte těmto
