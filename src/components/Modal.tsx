  ...
  return (
    <div className="modal-body">
      ...
      <ul>
        ...
        <li className="mb-3">
          Vína musí být vyráběna pouze z hroznů vypěstovaných na registrovaných
          vinicích v katastru obce Čejkovice s minimálním počtem 4.500 keřů na
          hektar. Hrozny musí být zdravé. Víno by mělo být ve větší míře
          formované vinohradem = terroir. Výnos u odrůdy Rulandské modré nesmí
          překročit 1,5 kg hroznů na keř a výnos u odrůdy Tramín nesmí překročit
          2 kg hroznů na keř.
        </li>
        <li className="mb-3">
        ...
        <li className="mb-3">
          ...
          láhve označovány kolkem Terroir Čejkovice nalepeným kolem hrdla lahve.
        </li>
        <li className="mb-3">
          Degustace probíhá minimálně jednou ročně. Degustační komise je složena
          ze členů spolku Čtvrtečníci - sdružení vinařů Čejkovice, z.s. a
          pracuje v minimálním počtu 11 osob.
        </li>
        <li className="mb-3">
          Degustační komise hodnotí vína body a také o vínech hlasuje. Víno je
          hodnoceno stobodovým systémem mezinárodní unie enologů, ale hodnotí se
          pouze body „po pěti“ např.: 85, 90, 95 a 100. Minimální bodové
          ohodnocení pro zařazení do Terroir Čejkovice je 85 bodů. Pokud je vínu
          uděleno méně jak 80 bodů musí být napsáno odůvodnění. Dále je o víně
          hlasováno, přičemž pro zařazení do Terroir Čejkovice je nutný souhlas
          2/3 hodnotících členů degustační komise.
        </li>
      </ul>
      <h4>
        Senzorické vlastnosti a technologické požadavky pro jednotlivé odrůdy:
      </h4>{' '}
      <h5>RULANDSKÉ MODRÉ </h5>
      <h6>
      ...
      <p>- víno musí mít obsah alkoholu minimálně 12,5 % obj.</p>
      <p>- víno musí zrát minimálně 12 měsíců v sudech</p>
      <p>- musí být provedena jablečno-mléčná fermentace</p>
      <p>
      ...
      <p>
        ...
        objemu vína, je uvedení vín na trh pod označením Terroir Čejkovice možné
        nejdříve po 19 měsících od 1. října roku sklizně hroznů
      </p>
      <p>
        - při využití nových vypalovaných sudů pro více než 33 % celkového
        objemu vína, je uvedení vín na trh pod označením Terroir Čejkovice možné
        nejdříve po 31 měsících od 1. října roku sklizně hroznů{' '}
      </p>
      <h5>TRAMÍN</h5>
      <h6>Hutné, harmonické a kořenité víno</h6>
      <p>
        - víno musí mít obsah zbytkového cukru (fruktóza + glukóza) maximálně 4
        g/l
      </p>
      <p>- víno musí mít obsah alkoholu minimálně 12,5 % obj.</p>
      <p>- víno musí zrát minimálně 9 měsíců</p>
      <p>- hrozny musí být macerovány minimálně 24 hodin</p>
      <p>- není povolena výroba technologií „oranžových vín“</p>
      <p>
        - víno musí zrát na jemných kalech minimálně 120 dní od konce fermentace
        nebo 150 dní od sklizně
      </p>{' '}
      ...
      - při využití nových vypalovaných sudů pro maximálně 33 % celkového objemu
      vína, je uvedení vín na trh pod označením Terroir Čejkovice možné nejdříve
      po 19 měsících od 1. října roku sklizně hroznů
      <p>
        - při využití nových vypalovaných sudů pro více než 33 % celkového
        objemu vína, je uvedení vín na trh pod označením Terroir Čejkovice možné
        nejdříve po 31 měsících od 1. října roku sklizně hroznů
      </p>
      <h6> Závěrečné ustanovení </h6> Autor statutu Terroir Čejkovice -
